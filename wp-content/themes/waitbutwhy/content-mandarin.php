<?php
/**
 * The template for displaying content in the single-mandarin.php template
 *
 * @package  WordPress
 * @file     content-mandarin.php
 * @author   FairPixels
...
<div style="clear:both;"></div>
			...
			<?php $mailCount = getSubCount(); ?>
					...
					<h2 style="font-size: 17px;">成为我们 <?php echo number_format($mailCount); ?> 中的一员，让我们每周通过邮件向您递送最新文章</h2>
