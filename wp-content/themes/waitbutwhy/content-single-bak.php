			...
			<?php wp_link_pages( array( 'before' => '<div class="page-link"><span>' . __( 'Pages:', 'fairpixels' ) . '</span>', 'after' => '</div>' ) ); ?>
              ...
              <!--div class="homeSocial">
                    ...
                    <div id="socBarmageddon">
                    	<div id="fbLikePost"><div id="fb-root" class="inline"></div><script src="http://connect.facebook.net/en_US/all.js#appId=507732202657943&amp;xfbml=1"></script><fb:like href="" send="true" layout="button_count" width="100" show_faces="false" font=""></fb:like></div>
                        
                        <div id="twitterSharePost"><a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.<?php echo ltrim($url,"http://"); ?>" data-via="waitbutwhy">Tweet</a>
...
<div class="orangeBox">
            ...
            <div id="like-wait-but-why" style="margin-bottom:0px;">
                ...
                <a href="http://www.facebook.com/waitbutwhy" target="_blank"><img src="<?php echo home_url(); ?>/wp-content/uploads/2013/12/like-wbw-fb-count.jpg" /></a>
                <h3 style="color:#fff; position:relative; top: -42px;left: 206px;"><?php echo get_option('fairpixels_facebook_followers'); ?></h3>
	...
	$excludeCats = '1';
	 ...
	 if ( fp_get_settings( 'fp_show_post_nav' ) == 1 ) { ?>
		<div class="entry-nav main-color-bg">
			<?php previous_post_smart( '<div class="prev"><i class="icon-chevron-left"></i><div class="link">%link</div></div>', __( 'Previous Post', true) ); ?>
			<?php next_post_smart( '<div class="next"><div class="link">%link</div><i class="icon-chevron-right"></i></div>', __( 'Next Post', true ) ); ?>
		</div>
	<?php } 
