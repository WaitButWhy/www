	...
	function widget( $args, $instance ) {
		...
		<div class="widget-tabs-title-container">
			<ul class="widget-tab-titles" class="list">
				...
				<li class="active"><h5><a href="#widget-tab2-content"><?php _e('Popular Posts', 'fairpixels'); ?></a></h5></li>
				...
				<?php if ( $latest_posts -> have_posts() ) : ?>
					...
					<?php while ( $latest_posts -> have_posts() ) : $latest_posts -> the_post(); ?>					
						<li>
							...
							<div class="thumbnail">
								<?php the_post_thumbnail( 'fp75_75' ); ?>
							</div>
							<?php } ?>
							...
							<div class="post-right">
								...
								<div class="entry-meta">
									...
									<?php $comments = get_comments_number();
										...
										<span class="comments">
											<i class="icon-comments"></i>
											<?php comments_popup_link( __('0', 'fairpixels'), __( '1', 'fairpixels'), __('%', 'fairpixels')); ?>		&nbsp;&nbsp;&nbsp;<i class="icon-facebook" style="color:#AAAAAA"></i> <fb:comments-count href="<?php the_permalink(); ?>"></fb:comments-count>
										</span>		
									<?php //} ?>	
								</div>
							</div>
