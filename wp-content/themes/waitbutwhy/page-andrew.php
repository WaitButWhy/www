	...
	<div class="older-postlist">
     ...
     <div class="cat-header">
				<div class="cat-title second-color-bg">
					<h4><?php echo the_title(); ?><img src="<?php echo get_template_directory_uri(); ?>/images/Andrew-Cave-full.png" style="position: absolute;margin-left: 20px;margin-top: -11px;" width="75" /></h4>				
                    </div>
                </div>
